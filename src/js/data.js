...
(function () {
  ...
  var INTAKE_FORM_QUERY_FIELDS = [
    ...
    // AI-generated triage-nurse summary (HTML written by the patient-portal
    // backend at intake step 8, see thc-portal/server/src/services/nurse-summary.ts).
    'content',
  ...
  function mapIntakeFormToContactShape(note) {
    ...
    // AI triage-nurse summary HTML (generated by patient-portal backend at
    // intake step 8). Stashed here so the clinician UI can surface it without
    // a second round-trip.
    if (note.content) out.__aiSummaryHtml = note.content;
